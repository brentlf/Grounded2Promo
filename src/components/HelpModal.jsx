        ...
        >
          ...
          >
            ...
            <ol className="space-y-3 text-sm text-white/85">
              <li><strong className="text-accent-green">1.</strong> Drag each piece of tape off the package.</li>
              <li><strong className="text-accent-green">2.</strong> Pull the ribbon end to untie the bow.</li>
